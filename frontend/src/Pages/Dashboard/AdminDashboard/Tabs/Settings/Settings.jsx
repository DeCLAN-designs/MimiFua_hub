...
import {
  ...
  FaUndo,
  FaCog,
  FaShieldAlt, // ✅ Correct security icon
  FaEnvelope,
  FaDatabase,
  FaChartBar,
  FaBell,
...
const Settings = ({ settings: propSettings, onSave }) => {
  const [activeTab, setActiveTab] = useState("general");
  const [settings, setSettings] = useState(
    propSettings || getDefaultSettings()
  );
  ...
  const tabs = [
    ...
    },
    {
      id: "security",
      label: "Security",
      icon: FaShieldAlt, // ✅ Ensure this matches import
  ...
  const validateSettings = () => {
    const errors = [];
    if (!settings.site_name?.trim()) errors.push("Site name is required");
